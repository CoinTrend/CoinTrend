...
private val TRACK_COLOR = StocksDarkBackground
...
private val BACKGROUND_SHAPE = RoundedCornerShape(20.dp)

@Composable
fun <T : Any> SegmentedControl(
    segments: ImmutableList<T>,
    selectedSegment: T,
    ...
    Layout(
        ...
        modifier = modifier
            ...
            .border(1.dp, color = StocksDarkSelectedCard, BACKGROUND_SHAPE)
...
fun SegmentText(text: String) {
    Text(text, maxLines = 1, overflow = Ellipsis, color = StocksDarkPrimaryText)
}
...
private fun Thumb(state: SegmentedControlState) {
    Box(
        Modifier
            ...
            .background(StocksDarkSelectedCard, BACKGROUND_SHAPE)
    )
}
